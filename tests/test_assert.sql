...
CALL ASSERT_SIGNALS(ASSERT_SQLSTATE, 'CALL TEST_VALUES(''ASSERT_IS_NULL(1)'')')!
CALL ASSERT_SIGNALS(ASSERT_SQLSTATE, 'CALL TEST_VALUES(''ASSERT_IS_NULL(1.0)'')')!
CALL ASSERT_SIGNALS(ASSERT_SQLSTATE, 'CALL TEST_VALUES(''ASSERT_IS_NULL(CURRENT DATE)'')')!
CALL ASSERT_SIGNALS(ASSERT_SQLSTATE, 'CALL TEST_VALUES(''ASSERT_IS_NULL(CURRENT TIMESTAMP)'')')!
CALL ASSERT_SIGNALS(ASSERT_SQLSTATE, 'CALL TEST_VALUES(''ASSERT_IS_NULL(CURRENT TIME)'')')!
CALL ASSERT_SIGNALS(ASSERT_SQLSTATE, 'CALL TEST_VALUES(''ASSERT_IS_NULL(''''foo'''')'')')!
...
CALL ASSERT_SIGNALS(ASSERT_SQLSTATE, 'CALL TEST_VALUES(''ASSERT_IS_NOT_NULL(CAST(NULL AS INTEGER))'')')!
CALL ASSERT_SIGNALS(ASSERT_SQLSTATE, 'CALL TEST_VALUES(''ASSERT_IS_NOT_NULL(CAST(NULL AS DOUBLE))'')')!
CALL ASSERT_SIGNALS(ASSERT_SQLSTATE, 'CALL TEST_VALUES(''ASSERT_IS_NOT_NULL(CAST(NULL AS DATE))'')')!
CALL ASSERT_SIGNALS(ASSERT_SQLSTATE, 'CALL TEST_VALUES(''ASSERT_IS_NOT_NULL(CAST(NULL AS TIMESTAMP))'')')!
CALL ASSERT_SIGNALS(ASSERT_SQLSTATE, 'CALL TEST_VALUES(''ASSERT_IS_NOT_NULL(CAST(NULL AS TIME))'')')!
CALL ASSERT_SIGNALS(ASSERT_SQLSTATE, 'CALL TEST_VALUES(''ASSERT_IS_NOT_NULL(CAST(NULL AS VARCHAR(10)))'')')!
...
CALL ASSERT_SIGNALS(ASSERT_SQLSTATE, 'CALL TEST_VALUES(''ASSERT_ROUTINE_EXISTS(''''BAR'''')'')')!
