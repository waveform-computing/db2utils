...
Returns the last day of month AMONTH in the year AYEAR, or the last day of the
month of ADATE.
...
Returns a DATE representing the last day of AMONTH in AYEAR, or the last day of
the month of ADATE depending on the variant of the function that is called.
